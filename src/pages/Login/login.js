        ...
        if (!response?.data?.user) {
          ...
          (async () => {
            try {
              ...
              if (response.data.user && response.data.user.status !== 'noactive') {
    ...
    <div className="imageBackground">
      <div id="formContainer" >
        <div id="form-Login">
          ...
          >
            <img className="formImg" src="https://thuthuatnhanh.com/wp-content/uploads/2021/06/hinh-anh-tre-em-vui-ve.jpg" alt='spaceship' />
          </div>
          <Form
